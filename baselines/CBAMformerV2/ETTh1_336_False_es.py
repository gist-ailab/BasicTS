...
from .arch import CBAMformerV2
# from .arch import Crossformer

CFG = EasyDict()

# ================= general ================= #
CFG.DESCRIPTION = "CBAMformerV2 model configuration "
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "CBAMformerV2"
CFG.MODEL.ARCH = CBAMformerV2
NUM_NODES = 7
CFG.MODEL.PARAM = {
    "n_feat": NUM_NODES,
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    '/SSDc/sowon/checkpoints_false_2',
