...
from .cbam_encoder import Encoder, EncoderRouter
from .cbam_decoder import Decoder, DecoderRouter
...
class CBAMformer2(nn.Module):
    def __init__(self, n_feat, in_ts_len, out_ts_len, seg_len, merge_win_size = 4,
                factor=10, d_seg=512, d_ff = 1024, n_heads=8, e_layers=3, 
                dropout=0.0, baseline = False):
        super(CBAMformer2, self).__init__()
